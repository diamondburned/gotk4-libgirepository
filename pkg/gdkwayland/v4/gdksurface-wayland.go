...
// GType values.
var (
	GTypeWaylandPopup    = coreglib.Type(girepository.MustFind("GdkWayland", "WaylandPopup").RegisteredGType())
	GTypeWaylandSurface  = coreglib.Type(girepository.MustFind("GdkWayland", "WaylandSurface").RegisteredGType())
	GTypeWaylandToplevel = coreglib.Type(girepository.MustFind("GdkWayland", "WaylandToplevel").RegisteredGType())
)
