...
// GType values.
var (
	GTypeScrolledWindowAccessible = coreglib.Type(girepository.MustFind("Gtk", "ScrolledWindowAccessible").RegisteredGType())
)
...
var GIRInfoScrolledWindowAccessibleClass = girepository.MustFind("Gtk", "ScrolledWindowAccessibleClass")
