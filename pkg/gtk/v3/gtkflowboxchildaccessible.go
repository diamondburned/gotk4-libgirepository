...
// GType values.
var (
	GTypeFlowBoxChildAccessible = coreglib.Type(girepository.MustFind("Gtk", "FlowBoxChildAccessible").RegisteredGType())
)
...
var GIRInfoFlowBoxChildAccessibleClass = girepository.MustFind("Gtk", "FlowBoxChildAccessibleClass")
