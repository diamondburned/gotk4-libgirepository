...
func (v *FontChooser) ConnectFontActivated(f func(fontname string)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(v, "font-activated", false, unsafe.Pointer(C._gotk4_gtk3_FontChooser_ConnectFontActivated), f)
}
...
func (f *FontChooserIface) Padding() [10]unsafe.Pointer {
	offset := GIRInfoFontChooserIface.StructFieldOffset("padding")
	valptr := (*[10]unsafe.Pointer)(unsafe.Add(f.native, offset))
